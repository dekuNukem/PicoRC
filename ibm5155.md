...
**ORANGE is Power Good**, is on the far right.
...
⚠️ **SLOWLY** ⚠️ slide the PSU outwards, feed in the cable as you go.

⚠️ **BEWARE OF CRT NECK of all times! It might be tight initially, DON'T RUSH!** ⚠️

⚠️ **Try not to bump into the neck!** ⚠️ It's game over if it's broken.
...
With the new fan, **TAPE OVER THE HOLE** for the old wire harness to improve cooling efficiency.
